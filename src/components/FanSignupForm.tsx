...
const FanSignupForm: React.FC<FanSignupFormProps> = ({ onClose, setIsAuthenticated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Fan signup form submitted:", formData); // Debug: Confirm form submission
    ...
    if (validateForm()) {
      ...
      try {
        ...
        const payload = {
          ...
          firstName,
          lastName,
          userType: "fan" as const, // Use 'as const' to ensure literal type
        };
        ...
        if (response.message === "Signup successful" && response.token) {
          ...
          // Redirect to the booking feed (Fan dashboard)
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Sign Up as a Fan</h2>
